        ...
        <div class="container">
            ...
            <div class="navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('TryItYourself*') ? 'active' : '' }}" href="../../TryItYourself"><i class="bi bi-person-arms-up" style="font-size: large;"></i><span class="d-none d-sm-inline">Try It Yourself</span></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('TryItYourself*') ? 'active' : '' }} disabled" href=""><i class="bi bi-person-arms-up" style="font-size: large;"></i><span class="d-none d-sm-inline">Try It Yourself</span></a>
                    </li>
                </ul>
            </div>
