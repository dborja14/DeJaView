        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('registerpost')}}" method="post" enctype="multipart/form-data">
                    ...
                    <label for="" style="color: red; display:flex; justify-content:center; align-items: center;">"Please be advised that this photo will be stored in our records."</label>
